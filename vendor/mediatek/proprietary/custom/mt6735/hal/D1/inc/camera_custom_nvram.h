...
typedef struct
{
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE-sizeof(UINT32)*2-sizeof(AE_NVRAM_T)-sizeof(AWB_NVRAM_T)*AWB_NVRAM_IDX_NUM-sizeof(FLASH_AWB_NVRAM_T)];
...
#define NVRAM_SWNR_TBL_NUM (20) // 20 by iso
typedef struct NVRAM_CAMERA_FEATURE_STRUCT_t
{
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE-sizeof(NVRAM_CAMERA_FEATURE_MFLL_STRUCT)-sizeof(NVRAM_CAMERA_FEATURE_SWNR_STRUCT)*NVRAM_SWNR_TBL_NUM*2];
