...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      "480x320",      "640x480",      "720x480",      "1024x768",     "1280x720",
                "1280x960", 	"1600x960",     "1600x1200",    "1920x1280",    "1920x1088",    "2048x1536",
                "2400x1440", 	"2400x1600",    "2560x1440",    "2560x1920",    "2880x1728",
            )
        ),
    )
#endif
