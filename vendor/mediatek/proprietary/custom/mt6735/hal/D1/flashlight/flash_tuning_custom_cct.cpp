...
int cust_fillDefaultStrobeNVRam_main (void* data)
{
	...
	for(i=0;i<8;i++)
    {
        ...
        p->tuningPara[i].histStretchMaxFgYTarget = 166;//285;//266;
        p->tuningPara[i].histStretchBrightestYTarget = 328;//404;//328;
	...
	p->engLevel.dutyH = 8;
        ...
        p->dualTuningPara.toleranceEV_pos = 0; //0.1 EV
        p->dualTuningPara.toleranceEV_neg = 0; //0.1 EV

        p->dualTuningPara.XYWeighting = 0;  //0.5  , 128 base
