...
#include "camera_AE_PLineTable_hi843_mipi_raw.h"                                                    
#include "camera_info_hi843_mipi_raw.h"                                                             
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            4296000, -1722000, -16000, -736000, 3942000, -646000, -286000, -2534000, 5382000
        },
        {  // i4P10[9]
            1295487, -884196, -403112, -177489, 411415, -233926, 109317, -368812, 263435
        },
        {  // i4P01[9]
            1240327, -490274, -743246, -445758, 481832, -36073, -109415, -1435607, 1548475
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AWB NVRAM
    {
        {
          {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    ...
                    -390,    // PWFluoLeftBound
                    -297,    // PWFluoUpperBound
                    -457    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -190,    // PIncaRightBound
        ...
        // Algorithm Tuning Paramter
        {
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {470, 512, 512}, {470, 512, 512}, {485, 512, 512}, {512, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}
                }, // F
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {470, 512, 512}, 
                    {470, 512, 512}, {485, 512, 512}, {500, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                }, // CWF
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
